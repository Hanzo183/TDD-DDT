...
class MathUtilityDDTTest {
    ...
    //mảng này sẽ là cái nguồn dữ liệu để hàm so sánh gọi, nhiều lần như thế, do nhiều data -> nguồn này là static để tìm kiếm nhanh chóng
    public static Object[][] innitTestData(){
